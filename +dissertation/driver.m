...
M_.endo_names(47) = {'g_uk'};
M_.endo_names_tex(47) = {'{g}'};
M_.endo_names_long(47) = {'Government Spending (UK)'};
M_.endo_names(48) = {'tr_uk'};
M_.endo_names_tex(48) = {'{TR}'};
M_.endo_names_long(48) = {'Tax Revenue (UK)'};
M_.endo_names(49) = {'b_uk'};
M_.endo_names_tex(49) = {'b\_uk'};
M_.endo_names_long(49) = {'b_uk'};
M_.endo_names(50) = {'debt_uk'};
M_.endo_names_tex(50) = {'debt\_uk'};
M_.endo_names_long(50) = {'debt_uk'};
M_.endo_names(51) = {'tr'};
M_.endo_names_tex(51) = {'tr'};
M_.endo_names_long(51) = {'tr'};
M_.endo_names(52) = {'tr_f'};
M_.endo_names_tex(52) = {'tr\_f'};
M_.endo_names_long(52) = {'tr_f'};
M_.endo_names(53) = {'tau_uk'};
M_.endo_names_tex(53) = {'{\tau^{uk}}'};
M_.endo_names_long(53) = {'Labour Tax (UK)'};
M_.endo_names(54) = {'interest'};
M_.endo_names_tex(54) = {'{i}'};
M_.endo_names_long(54) = {'Interest Rate (Scotland)'};
M_.endo_names(55) = {'interest_f'};
M_.endo_names_tex(55) = {'{i^f}'};
M_.endo_names_long(55) = {'Interest Rate (rUK)'};
M_.endo_names(56) = {'interest_uk'};
M_.endo_names_tex(56) = {'{i^f}'};
M_.endo_names_long(56) = {'Interest Rate (UK)'};
M_.endo_names(57) = {'nu_uk'};
M_.endo_names_tex(57) = {'{\nu}'};
M_.endo_names_long(57) = {'AR(1) monetary policy shock process'};
...
M_.mapping.wp_f.eqidx = [19 57 ];
M_.mapping.p_h_uk.eqidx = [26 55 ];
...
M_.mapping.tau_uk.eqidx = [11 12 13 14 18 19 26 ];
...
M_.state_var = [8 16 17 18 20 21 22 31 39 40 41 43 44 47 49 57 58 ];
...
options_.irf = 30;
options_.order = 2;
var_list_ = {'nx';'nx_f';'y_star';'interest';'interest_f';'interest_uk';'s';'s_f';'s_nat';'s_nat_f';'debt_uk';'b_uk';'g_uk';'tr_uk';'tau_uk';'c';'c_f';'y';'y_f';'wp';'wp_f';'n';'n_f';'p_h';'p_h_f';'pi_h';'pi_h_f';'p';'p_f';'w';'w_f';'pi';'pi_f'};
