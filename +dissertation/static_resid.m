...
residual(31) = lhs - rhs;
lhs = y(30);
rhs = y(30)-(y(32)-y(31)-y(34))*1/T(2);
residual(32) = lhs - rhs;
lhs = y(33);
rhs = T(3)*y(50)+T(4)*y(52);
residual(33) = lhs - rhs;
lhs = y(34);
rhs = y(50)*(1-params(23))*T(3)*(-T(2))+y(52)*((1-params(21))*T(1)-T(2)*T(4))*(1-params(26));
residual(34) = lhs - rhs;
lhs = y(35);
rhs = T(2)*y(33)-y(52)*(1-params(21))*T(6);
residual(35) = lhs - rhs;
lhs = y(37);
rhs = T(2)*y(30);
residual(36) = lhs - rhs;
...
residual(41) = lhs - rhs;
lhs = y(51);
rhs = (0.5*y(51)+y(23)*0.5)*params(24)+x(5);
residual(42) = lhs - rhs;
lhs = y(50);
rhs = y(50)*params(23)+x(6);
residual(43) = lhs - rhs;
lhs = y(52);
rhs = y(52)*params(26)+x(7);
residual(44) = lhs - rhs;
lhs = y(42)-y(47);
rhs = params(15)*y(44)+params(17)*y(40);
residual(45) = lhs - rhs;
lhs = y(43);
rhs = y(38)*params(21)*((params(15)*params(22)+(1-params(21))*(params(15)*params(22)-1))/params(15)-1)-y(52)*params(21)/params(15);
residual(46) = lhs - rhs;
lhs = y(43);
