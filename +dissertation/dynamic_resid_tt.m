...
T(2) = params(1)*T(1);
T(3) = (1-params(4))/(1-params(4)+params(4)*params(5))*(1-params(6))*(1-params(6)*params(2))/params(6)*((params(4)+params(3))/(1-params(4))+params(29)*T(2));
T(4) = 1/(1+params(19)*(params(13)*params(20)+(1-params(19))*(params(13)*params(20)-1)-1));
T(5) = params(13)*T(4);
T(6) = (1-params(16))/(1-params(16)+params(16)*params(17))*(1-params(18))*(1-params(18)*params(14))/params(18)*((params(16)+params(15))/(1-params(16))+params(30)*T(5));
