...
residual(10) = lhs - rhs;
lhs = y(20);
rhs = y(38)*T(9)+y(39)*T(8)+y(37)*T(7)+y(64)*T(10)+y(70)*T(15);
residual(11) = lhs - rhs;
lhs = y(43);
rhs = y(60)*T(13)+y(61)*T(12)+y(37)*T(11)+y(64)*T(14)+y(70)*T(16);
residual(12) = lhs - rhs;
lhs = y(21);
rhs = y(38)*(1-params(9))*T(9)*params(29)*(-T(2))+(y(78)-y(37))*T(2)*(params(7)*(params(1)*params(8)+(1-params(7))*(params(1)*params(8)-1)-1)+params(29)*T(7))+y(39)*(1-params(12))*((1-params(7))*T(1)-params(29)*T(2)*T(8))-y(64)*(1-params(33))*T(2)*(params(29)*T(10)-params(31))+(y(81)-y(70))*params(29)*T(2)*T(15);
residual(13) = lhs - rhs;
lhs = y(44);
rhs = y(60)*(1-params(21))*T(13)*params(30)*(-T(5))+(y(78)-y(37))*T(5)*(params(19)*(params(13)*params(20)+(1-params(19))*(params(13)*params(20)-1)-1)+params(30)*T(11))+y(61)*(1-params(24))*((1-params(19))*T(4)-params(30)*T(5)*T(12))-y(64)*(1-params(33))*T(5)*(params(30)*T(14)-params(32))+(y(81)-y(70))*params(30)*T(5)*T(16);
residual(14) = lhs - rhs;
lhs = y(22);
rhs = (params(29)*y(20)-y(37)-params(31)*y(64))*T(2)-y(39)*(1-params(7))*T(1);
residual(15) = lhs - rhs;
lhs = y(45);
rhs = (params(30)*y(43)-y(37)-params(32)*y(64))*T(5)-y(61)*(1-params(19))*T(4);
residual(16) = lhs - rhs;
lhs = y(37)-y(5);
...
rhs = y(23)-y(31)-y(64)-params(7)*y(25);
residual(20) = lhs - rhs;
lhs = 1/(1-params(37))*y(53);
rhs = y(46)-y(54)-y(64)-params(19)*y(48);
residual(21) = lhs - rhs;
lhs = y(30);
...
residual(25) = lhs - rhs;
lhs = y(65);
rhs = y(70)+params(37)*y(68)+(1-params(37))*y(69)-y(63);
residual(26) = lhs - rhs;
lhs = y(65);
rhs = y(64)*params(35)+params(34)*y(15);
residual(27) = lhs - rhs;
lhs = y(66);
rhs = 1/params(2)*(y(64)*(1-params(35))+(1-params(34))*y(15));
residual(28) = lhs - rhs;
lhs = y(64);
