\begin{figure}[H] \centering % Created by tikzDevice version 0.12.4 on 2023-07-24 17:06:28
% !TEX encoding = UTF-8 Unicode
\begin{tikzpicture}[x=1pt,y=1pt]
\definecolor{fillColor}{RGB}{255,255,255}
\definecolor{fillColorT}{RGB}{255,0,255}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (216.81,588.57) {Fiscal (Scenario 4)};
\end{scope}
\end{tikzpicture}
\vspace{-1cm}
\caption{Dynamic responses in Scotland and rUK following an expansionary fiscal policy shock}
\end{figure}