...
\end{align}
which implies that output in current period depends not only on expected output, inflation, and change in world output, but it also depends on expected government spending. Equation (\ref{eq:a_version_of_dis}) implies that the natural rate of interest is:
